...
from envs.MATC_2a2d2t_Room.MATC_Room import GameEnv
...
if IS_SAVE_LOG:
    ...
    writer = tf.summary.FileWriter(logs_path + 'g5g0_lr1_1e11e1_l30fc64b64m5k2kv20_non_soft/seed' + str(seed), sess.graph)
#
