...
from envs.MATC_2a2d8t_Ring.MATC_Ring import GameEnv
...
parser.add_argument('--subpolicy-len', type=int, default=30)
...
meta_dqn1 = metaDQN(n_features=game_size * game_size * 3 + 1,
                    n_actions=goal_num,
...
dqn1 = DQN(n_features=game_size * game_size * 4 + 1,
...
meta_dqn2 = metaDQN(n_features=game_size * game_size * 3 + 1,
                    n_actions=goal_num,
                    learning_rate=meta_lr,
                    reward_decay=meta_gamma,
                    replace_target_iter=100,
...
dqn2 = DQN(n_features=game_size * game_size * 4 + 1,
           n_actions=nav_action_num,
           learning_rate=lr,
           reward_decay=gamma,
           replace_target_iter=100,
...
if IS_SAVE_LOG:
    ...
    writer = tf.summary.FileWriter(logs_path + 'g5g0_lr1_1e11e1_l30fc65b64m5k2kv20p50k_non_soft/seed' + str(seed), sess.graph)
#
...
a1_g3_max_success_rate_100 = 0
a2_g3_max_success_rate_100 = 0
a1_g4_max_success_rate_100 = 0
a2_g4_max_success_rate_100 = 0
...
# while True:
    ...
    a1_goal3 = a1_goal3[-100:]
    a1_goal4 = a1_goal4[-100:]
    a2_goal0 = a2_goal0[-100:]
    a2_goal1 = a2_goal1[-100:]
    a2_goal2 = a2_goal2[-100:]
    a2_goal3 = a2_goal3[-100:]
    a2_goal4 = a2_goal4[-100:]
    ...
    a1_g3_success_rate_recent_100 = sum(a1_goal3) / 100.0
    a1_g4_success_rate_recent_100 = sum(a1_goal4) / 100.0
    ...
    a2_g3_success_rate_recent_100 = sum(a2_goal3) / 100.0
    a2_g4_success_rate_recent_100 = sum(a2_goal4) / 100.0
    ...
    a1_g3_max_success_rate_100 = a1_g3_max_success_rate_100 if a1_g3_success_rate_recent_100 < a1_g3_max_success_rate_100 else a1_g3_success_rate_recent_100
    a1_g4_max_success_rate_100 = a1_g4_max_success_rate_100 if a1_g4_success_rate_recent_100 < a1_g4_max_success_rate_100 else a1_g4_success_rate_recent_100
    ...
    a2_g3_max_success_rate_100 = a2_g3_max_success_rate_100 if a2_g3_success_rate_recent_100 < a2_g3_max_success_rate_100 else a2_g3_success_rate_recent_100
    a2_g4_max_success_rate_100 = a2_g4_max_success_rate_100 if a2_g4_success_rate_recent_100 < a2_g4_max_success_rate_100 else a2_g4_success_rate_recent_100
    # g1_max_success_rate_100 = g1_success_rate_recent_100 if g1_max_success_rate_100 < g1_success_rate_recent_100 else g1_max_success_rate_100
    ...
    if episode % print_interval == 0:
        print('--Episode:', episode, '. Train time:', train_time,
              ...
              '. g3_sr:', a1_g3_success_rate_recent_100, '(', a1_g3_max_success_rate_100, ')', '/',
              a2_g3_success_rate_recent_100, '(', a2_g3_max_success_rate_100, ')',
              '. g4_sr:', a1_g4_success_rate_recent_100, '(', a1_g4_max_success_rate_100, ')', '/',
              a2_g4_success_rate_recent_100, '(', a2_g4_max_success_rate_100, ')',
